...
const HeroSection = () => {
    ...
    return (
        <section className="relative flex flex-col items-center justify-center h-screen overflow-hidden text-white">
            ...
            <div className="absolute top-[20%] right-[10%] w-[350px] h-[350px] bg-[#00B4FF]/20 blur-[160px] rounded-full animate-pulseSlow"></div>
            <div className="absolute bottom-[10%] left-[10%] w-[450px] h-[450px] bg-[#0D47A1]/25 blur-[180px] rounded-full animate-pulseSlow delay-300"></div>

            {/* === Section Header === */}
            <div className="text-center mb-10 z-10">
                <h1 className="text-4xl md:text-6xl font-bold text-[#00B4FF] mb-2 tracking-wide drop-shadow-[0_0_15px_rgba(0,180,255,0.4)]">
                    Our Expertise
                </h1>
            ...
            <div className="relative w-full flex justify-center items-center perspective-[1000px] h-[380px] md:h-[420px] z-10">
                {slides.map((slide, index) => {
                    ...
                    return (
                        <div
                            key={slide.id}
                            className="absolute w-[280px] md:w-[340px] h-[220px] md:h-[250px] rounded-2xl overflow-hidden text-center transition-all duration-700 ease-in-out transform-gpu border border-[#00B4FF]/20 shadow-[0_0_25px_rgba(0,180,255,0.2)] hover:shadow-[0_0_40px_rgba(0,180,255,0.4)]"
                            style={{
                                transform,
                                opacity,
